        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12">
          ...
          <div>
            ...
            >
              ...
              <GlowEffect color="accent" intensity={0.15} size={1} pulseEffect={true}>
                <div className="bg-card/30 backdrop-blur-sm border border-border/30 rounded-xl p-4 flex items-center space-x-4">
                  ...
                  >
                    <FloatingElement intensity={0.2} speed={0.5}>
                      <a 
                        ...
                        className="text-muted hover:text-foreground hover:translate-x-1 transition-all flex items-center"
                      >
                        <svg 
          ...
          <div>
            ...
            >
              ...
              <FloatingElement intensity={0.2} speed={0.7}>
